...
export CFLAGS="$CFLAGS -DBACKOFF=100"
...
method="gm naive"
timeout="300000000" #5 min of simmulation time (or ~200 epochs for 1.5 sec epochs
for meth in $method
do
    ...
    sed -i -e "s/TOTAL_TIMEOUT/330000000/g" $new_sim
