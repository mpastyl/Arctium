...
//#define CRYSTAL_INTER_PHASE_GAP (RTIMER_SECOND / 100) // 10 ms
#define CRYSTAL_INTER_PHASE_GAP (RTIMER_SECOND / 125) // 8 ms
//#define CRYSTAL_INTER_PHASE_GAP (RTIMER_SECOND / 166) // 6 ms
//#define CRYSTAL_INTER_PHASE_GAP (RTIMER_SECOND / 200) // 5 ms
