...
export CFLAGS="$CFLAGS -DBACKOFF=80"
...
export CFLAGS="$CFLAGS -DTX_POWER=31 -DRF_CHANNEL=26 -DCONCURRENT_TXS=5 -DNUM_ACTIVE_EPOCHS=1 -DN_TX_S=3 -DN_TX_T=3 -DN_TX_A=3 -DDUR_S_MS=4 -DDUR_T_MS=4 -DDUR_A_MS=4 -DCRYSTAL_LONGSKIP=0 -DCRYSTAL_SYNC_ACKS=1"
export CFLAGS="$CFLAGS -DCRYSTAL_SINK_MAX_EMPTY_TS=5 -DCRYSTAL_MAX_SILENT_TAS=2 -DCRYSTAL_MAX_MISSING_ACKS=4 -DCRYSTAL_SINK_MAX_NOISY_TS=6"
...
do
    ...
    cp /media/sf_geometric_monitoring_shared/geometric-monitoring/contiki_project/26_nodes_crystal_generic.csc $new_sim
...
do
     ...
     do
         ...
         cp crystal.sky "/media/sf_geometric_monitoring_shared/geometric-monitoring/contiki_project/executables/crystal_"$meth"_"$node".sky"
         cp crystal.sky "/media/sf_geometric_monitoring_shared/geometric-monitoring/contiki_project/testing_folder/crystal_"$meth"_"$node".sky"
         rm crystal.sky
     done
done
